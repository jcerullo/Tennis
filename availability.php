...
<section>
	...
	<p> Take care that the correct month is displayed 
	<br> Next month is the display default.  If entering availability 
	<br> dates for the current month, then first select "Change Month"	
	<br> from the menu above.
	</p>
	</figure>
