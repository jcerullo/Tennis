...
<?php
  function init() {
    ...
    if (filter_has_var(INPUT_POST, "mbrID")){
        $mbrID = trim(filter_input(INPUT_POST, "mbrID"));		
	...
	try {                                                
		...
		$result = $con->query("SELECT * FROM admin WHERE adminID = '$mbrID' AND leagueID = '$leagueID' ");
		$result->setFetchMode(PDO::FETCH_ASSOC);
		foreach ($result as $row) {
...
//                                                                                   load page settings	
	try {                                                
        ...
        $result = $con->query("SELECT * FROM settings WHERE rcdNbr > 0 AND leagueID = '$leagueID' ");
		$result->setFetchMode(PDO::FETCH_ASSOC);
...
<section class="jumbotron">
  <div class="container">
    <div class="row text-center">
      ...
      <h2>$leagueName</h2><br>
      <h3>Moderated By $moderatedBy</h3><br>
