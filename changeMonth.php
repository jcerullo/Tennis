...
<nav id="nav">
	<ul id="navigation">
		...
		<li><a href="availability.php">Change Month</a></li>
...
<section>
	...
	<p> Only Saturdays should currently be selected</p>
	</figure>
...
<?php 	 
	try {
        ...
        $query = "SELECT dates as 'You are available on the following dates:' FROM available WHERE mbrID = '$mbrID' AND leagueID = '$leagueID' ";
