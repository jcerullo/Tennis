...
<?php
  ...
  init();
	...
	if ($mbrID != "Guest") {
        ...
        $phoneSecondary = trim(filter_input(INPUT_POST, "phoneSecondary"));	  
        $village = trim(filter_input(INPUT_POST, "village"));	  
        $streetAddr = trim(filter_input(INPUT_POST, "streetAddr"));	  
        $cityAddr = trim(filter_input(INPUT_POST, "cityAddr"));	  
        $zipAddr = trim(filter_input(INPUT_POST, "zipAddr"));	  
        $emailAddr = trim(filter_input(INPUT_POST, "emailAddr"));	  
        $status = trim(filter_input(INPUT_POST, "status"));	  
        $password = trim(filter_input(INPUT_POST, "password"));	  
        $tennisRanking = trim(filter_input(INPUT_POST, "tennisRanking"));
		$displayPhoto = trim(filter_input(INPUT_POST, "displayPhoto"));
		...
		if ($displayPhoto == "n") $displayPhoto = "N";
        ...
        $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	        ...
	        $result = $con->prepare("UPDATE member
					  ...
					  WHERE mbrID = '$mbrID' AND leagueID = '$leagueID' ");
			$result->execute();
	...
	try {                                                // retrieve SQL record
        ...
        $result = $con->query("SELECT * FROM member WHERE mbrID = '$mbrID' AND leagueID = '$leagueID' ");
		$result->setFetchMode(PDO::FETCH_ASSOC);
...
<?php
print "<p>...... You are logged in as <strong> $mbrID </strong> on the <strong>Member Profile </strong>  page of $leagueName</p>";
print <<<HERE
  <div class = "member"> 
  <style type = "text/css">
            fieldset {
